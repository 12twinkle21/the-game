...
function ActiveFriendItem(props) {
  ...
  return (
   ...
   <div className={darkTheme? styles.darkActiveFriendItem : styles.activeFriendItem} style={forSlider?{marginRight: '18px', marginBottom: '10px'} : null}>
      <div className={darkTheme? styles.darkActiveFriendItem__avatar : styles.activeFriendItem__avatar}>
         <img src={avatar} width={48} height={48} alt='Avatar'/>
         {
            isOnline?
               <div className={darkTheme? styles.darkActiveFriendItem__online : styles.activeFriendItem__online}>
      ...
      <div className={darkTheme? styles.darkActiveFriendItem__info : styles.activeFriendItem__info}>
         <div className={darkTheme? styles.darkActiveFriendItem__name : styles.activeFriendItem__name}>
            <p>{name}</p>
         </div>
         <div className={darkTheme? styles.darkActiveFriendItem__gold : styles.activeFriendItem__gold}>
