...
let [visibleAttachmentsPopup, setVisibleAttachmentsPopup] = React.useState();

let onVisibleAttachmentsPopup = () =>{
   setVisibleAttachmentsPopup(!visibleAttachmentsPopup);
}

let [visibleMoreBtnPopup, setVisibleMoreBtnPopup] = React.useState();

let onVisibleMoreBtnPopup = () =>{
   setVisibleMoreBtnPopup(!visibleMoreBtnPopup);
}
  ...
  return (
    ...
    <div className={darkTheme? styles.darkDetailPublication : styles.detailPublication}>
      <div className={darkTheme? styles.darkDetailPublication__top : styles.detailPublication__top}>
         ...
         <div className={styles.moreBtn} onClick={onVisibleMoreBtnPopup}>
