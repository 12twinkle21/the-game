  ...
  let usefulArticlesData = [
    {
      ...
      text: "Узнайте больше о том, как древо достижений помогает организовать учебный процесс."
    },
    {
    ...
    <div className={styles.achievementBlock}>
      ...
      <div className={styles.usefulArticlesBlock}>
        ...
        <Slider {...bottomSliderSettings}>
          {
            usefulArticlesData.map((item) => <UsefulArticlesItem image={item.image} type={item.type} title={item.title} text={item.text}/>)
          }
        </Slider>
        </div>
      </div>
